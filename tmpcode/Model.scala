...
object Inception_Layer_v1 {
  def apply(inputSize: Int, config: Table, namePrefix : String = "") : Module[Float] = {
    ...
    conv1.add(Echo().setName(namePrefix + "1*1"))
    ...
    conv3.add(Echo().setName(namePrefix + "3*3_reduce"))
    ...
    conv3.add(Echo().setName(namePrefix + "3*3"))
    ...
    conv5.add(Echo().setName(namePrefix + "5*5_reduce"))
    ...
    conv5.add(Echo().setName(namePrefix + "5*5"))
    ...
    pool.add(Echo().setName(namePrefix + "pool_proj"))
